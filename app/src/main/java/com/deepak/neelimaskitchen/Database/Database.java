package com.deepak.neelimaskitchen.Database;
...
public class Database extends SQLiteAssetHelper {
    private static final String DB_NAME = "nkcartdb2.db";
    ...
    public List<Order> getCarts() {
        ...
        //If list has data, start getting data
        if (c.moveToFirst()) {
            ...
            //Continue to get data from list as long as it can move to the next row
            while (c.moveToNext());
        }
